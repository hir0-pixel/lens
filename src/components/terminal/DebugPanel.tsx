...
export function DebugPanel() {
  return (
    <div className="flex h-full flex-col bg-[var(--ds-panel)] text-[13px] text-[var(--ds-fg)]">
      <div className="flex h-[28px] shrink-0 items-center gap-2 border-b border-[var(--ds-border)] px-2">
        <button
          ...
          className="flex cursor-not-allowed items-center gap-1 rounded-[2px] px-1.5 py-0.5 text-[12px] text-[var(--ds-fg-muted)] opacity-50"
        >
          <Play className="h-3.5 w-3.5 text-[var(--ds-success)]" strokeWidth={1.5} />
          Start Debugging
        </button>
        <span className="text-[11px] text-[var(--ds-fg-muted)] opacity-50">
          F5
        </span>
      </div>
