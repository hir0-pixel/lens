...
function ExplorerGlyph({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <rect x="8.15" y="7.15" width="5.35" height="5.2" rx="0.7" fill="#4BA3E8" />
    </svg>
  );
}
...
function CursorLogo({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path fill="#EDEDED" d="M6.4 4.6 17.8 12.15l-5.55 1.28L8.7 20.2z" />
      <path fill="#9A9A9A" d="m12.25 13.43 5.55-1.28-2.85 8.05-4.55-1.2z" />
      <path fill="#555" d="m12.25 13.43 2.15 5.57-5.7 1.2z" />
    </svg>
  );
}
    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset="0.45" stopColor="#087CFA" />
