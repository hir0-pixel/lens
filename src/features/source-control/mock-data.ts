...
export const MOCK_REPOS: GitRepository[] = [
  {
    ...
    provider: "github",
    remoteUrl: "https://github.com/orchids/finance-dashboard",
    defaultBranch: "main",
  },
  {
    id: "repo-2",
    ...
    provider: "github",
    remoteUrl: "https://github.com/orchids/chrome-buddy",
    defaultBranch: "main",
  },
];
...
export const MOCK_COMMITS: GitCommit[] = [
  ...
  },
  {
    ...
    shortHash: "e1f2a3b",
    message: "Initial commit: Orchids desktop Tauri + React IDE",
    author: "Maryam",
    email: "maryam@orchids.app",
    avatarColor: "#FCAA26",
