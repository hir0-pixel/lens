...
export function applyAppearance(settings: AppearanceSettings): void {
  ...
  if (resolved === "dark") {
    ...
    root.style.setProperty("--border-focus", "#7183ff");
    root.style.setProperty("--focus-ring-color", "#7183ff");
    root.style.setProperty("--focus-ring-width", "2px");
    root.style.setProperty("--focus-ring-offset", "2px");
    root.style.setProperty("--cursor-focus", "#7183ff");
    root.style.setProperty("--link", "#7183ff");
