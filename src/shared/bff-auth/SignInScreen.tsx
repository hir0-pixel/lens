  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col items-center justify-center overflow-y-auto bg-[var(--bg-base)] px-6 py-16">
      ...
      <div className="relative z-[1] flex w-full max-w-[420px] flex-col items-center text-center">
        ...
        <h1 className="type-display-sm text-[var(--text-primary)]">
          Work securely in Lens
        </h1>
        <p className="mt-2 max-w-[340px] type-body-md text-[var(--text-secondary)]">
        ...
        <div className="mt-8 w-full max-w-[280px]">
          <Button
            ...
            className="btn-primary h-11 w-full type-button"
          >
        ...
        {!authEnabled && (
          <p className="mt-3 max-w-[320px] type-caption leading-relaxed text-[var(--text-tertiary)]">
